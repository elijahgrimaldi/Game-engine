...
namespace Haku {
    ...
    void ImGuiLayer::OnUpdate()
    {
        ...
        // Begin ImGui debug overlay window
        ImGui::Begin("Debug Overlay");

        // Display keyboard key states
        ...
        // End ImGui debug overlay window
        ImGui::End();
    ...
    bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
    {
        ...
        io.SetKeyEventNativeData(imgui_key, keycode, glfwGetKeyScancode(keycode));
        return true;
    }
